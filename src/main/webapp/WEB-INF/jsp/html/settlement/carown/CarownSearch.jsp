				...
				<div class="row">
					<div class="col-6">
						<div class="form-group row mb-3">
							<label for="carOwnerSettlementStatus" class="col-2 col-form-label">지급상태</label>
							<div class="col-5">
								<!-- ktds요청으로 정산실패 추가 by 2022.05.24 mijin.kim -->
								<select class="form-control" id="carOwnerSettlementStatus" name="carOwnerSettlementStatus">
									...
									<c:forEach var="carOwnerSettlementStatusList" items="${settlementStatusList}">
										<c:if test="${'settlementStandby' eq carOwnerSettlementStatusList.codeId
											 ...
											 or 'cancelRequested' eq carOwnerSettlementStatusList.codeId
											 or 'cancelCompleted' eq carOwnerSettlementStatusList.codeId
											 or 'confirmRequired' eq carOwnerSettlementStatusList.codeId
											 or 'sendFailed' eq carOwnerSettlementStatusList.codeId}">
						...
						<div class="form-group row mb-3">
							...
							<div class="col-4">
								<select class="form-control" id="searchType" name="searchType">
									...
									<option value="carOwnerCompany">차주사</option>
						...
						<div class="row">
							<div class="col-2">
								<select class="form-control" id="pickerType" name="pickerType">
									<option value="complete">지급발생일</option>
									<option value="deposit">지급완료일</option>
								</select>
							</div>
							<div class="col-4">
			...
			<div class="col-10">
				<div class="row">
					<div class="col-6">
						<div class="form-group row mb-3">
							<%-- TOOD 승인상태 --%>
							<label for="carOwnerSettlementStatus" class="col-2 col-form-label">진행상태</label>
							<div class="col-5">
								<select class="form-control" id="carOwnerSettlementStatus" name="carOwnerSettlementStatus">
									<option value="all">진행상태(전체)</option>
									<c:forEach var="settlementStatusList" items="${settlementStatusList}">
										<c:if test="${'settlementStandby' eq settlementStatusList.codeId
											 or 'settlementRequested' eq settlementStatusList.codeId
											 or 'settlementCompleted' eq settlementStatusList.codeId
											 or 'settlementFailed' eq carOwnerSettlementStatusList.codeId
											 or 'cancelRequested' eq settlementStatusList.codeId
											 or 'cancelCompleted' eq settlementStatusList.codeId
											 or 'confirmRequired' eq settlementStatusList.codeId
											 or 'sendFailed' eq settlementStatusList.codeId}">
											<option value="${settlementStatusList.codeId}">${settlementStatusList.codeName}</option>
										</c:if>
				...
				<div class="form-group row mb-3">
					...
					<div class="col-11">
						<div class="row">
							<div class="col-2">
								<select class="form-control" id="pickerType" name="pickerType">
									<option value="complete">차주발생일</option>
									<option value="deposit">차주완료일 </option>
								</select>
							</div>
							<div class="col-4">
								<div class="picker-wrap">
